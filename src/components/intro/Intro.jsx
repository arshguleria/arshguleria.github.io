    ...
    <div className="i">
      <div className="i-left">  
        ...
        <div className="i-left-wrapper">
          ...
          <p className="i-desc">
          I'm a passionate developer with a genuine curiosity for the world
          of technology. With a strong background in engineering and 
          a knack for crafting seamless user experiences.
          </p>
        </div>
        <svg
          width="75"
